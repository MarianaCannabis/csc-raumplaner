...
Stand: 2026-04-28 — auto-generiert via `node scripts/audit-functions.mjs`.
...
### src/legacy/bimViewer.ts

- `exportCurrentSceneAsIfc` (line 53)
- `createBimViewer` (line 81)
...
### src/legacy/floorManager.ts

- `DEFAULT_FLOOR_HEIGHT` (line 26)
- `getDefaultFloors` (line 28)
- `recomputeZOffsets` (line 39)
- `addFloor` (line 78)
- `removeFloor` (line 99)
- `renameFloor` (line 104)
- `setFloorHeight` (line 108)
- `validateFloors` (line 118)
...
- `openHelpModal` (line 14)
- `openHelp` (line 18)
- `closeHelp` (line 24)
- `showHelpPage` (line 29)
...
### src/legacy/selfTest.ts

- `runSelfTest` (line 139)
- `renderSelfTestResults` (line 159)

### src/legacy/stairsGeometry.ts

- `buildStairsMesh` (line 32)
- `buildSpiralStairsMesh` (line 215)
- `getStairsZRange` (line 293)
...
### src/persist/subscriptions.ts

- `fetchSubscription` (line 36)
- `setUserPlan` (line 62)
- `getCurrentPlan` (line 124)
...
| Function | Line |
|---|---|
| `_loadTelemetryScripts` | 2430 |
| `_showCrashModal` | 2520 |
| `loadSharedFurniture` | 2713 |
| `saveSharedFurniture` | 2730 |
| `deleteSharedFurniture` | 2757 |
| `aiFetch` | 2774 |
| `callAI` | 2801 |
| `aiText` | 2849 |
| `aiJSON` | 2855 |
| `testAIConnection` | 2869 |
| `loadCustom` | 2917 |
| `saveCustom` | 2918 |
| `getCatalog` | 2928 |
| `getArchCatalog` | 2936 |
| `getSecurityCatalog` | 2937 |
| `toggleCatGroup` | 2938 |
| `findItem` | 2950 |
| `m2px` | 2985 |
| `px2m` | 2986 |
...
| `drawGround2D` | 3184 |
| `hitGround` | 3221 |
| `hitGroundResizeHandle` | 3238 |
| `_getImgCached` | 3253 |
| `drawObj2D` | 3264 |
| `drawMeasure` | 3366 |
| `hitObj` | 3387 |
| `hitRoom` | 3397 |
| `hitRoomResizeHandle` | 3405 |
| `startCatalogDrag` | 3671 |
| `placeFromCatalog` | 3681 |
| `quickAddRoom` | 3705 |
| `addRoom` | 3711 |
| `addObject` | 3733 |
| `removeRoom` | 3757 |
...
| `removeGround` | 3792 |
| `selectGround` | 3801 |
| `openGroundMaterialPicker` | 3811 |
| `closeGroundMaterialPicker` | 3831 |
| `openGroundPropPanel` | 3837 |
| `closeGroundPropPanel` | 3883 |
| `syncGroundPropPanel` | 3887 |
| `deleteSelectedGround` | 3897 |
| `setSelection` | 3902 |
| `updateSelBotBar` | 3930 |
| `applySelProps` | 3966 |
| `rotateSel` | 3976 |
| `dupSel` | 3995 |
| `deleteSel` | 4001 |
