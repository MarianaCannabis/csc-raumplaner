...
| Function | Line |
|---|---|
| `_loadTelemetryScripts` | 2375 |
| `_showCrashModal` | 2465 |
| `loadSharedFurniture` | 2658 |
| `saveSharedFurniture` | 2675 |
| `deleteSharedFurniture` | 2702 |
| `aiFetch` | 2719 |
| `callAI` | 2746 |
| `aiText` | 2794 |
| `aiJSON` | 2800 |
| `testAIConnection` | 2814 |
| `loadCustom` | 2862 |
| `saveCustom` | 2863 |
| `getCatalog` | 2873 |
| `getArchCatalog` | 2881 |
| `getSecurityCatalog` | 2882 |
| `toggleCatGroup` | 2883 |
| `findItem` | 2895 |
| `m2px` | 2923 |
| `px2m` | 2924 |
...
| `drawGround2D` | 3122 |
| `hitGround` | 3159 |
| `hitGroundResizeHandle` | 3176 |
| `_getImgCached` | 3191 |
| `drawObj2D` | 3202 |
| `drawMeasure` | 3304 |
| `hitObj` | 3325 |
| `hitRoom` | 3335 |
| `hitRoomResizeHandle` | 3343 |
| `startCatalogDrag` | 3609 |
| `placeFromCatalog` | 3619 |
| `quickAddRoom` | 3643 |
| `addRoom` | 3649 |
| `addObject` | 3671 |
| `removeRoom` | 3695 |
...
| `removeGround` | 3730 |
| `selectGround` | 3739 |
| `openGroundMaterialPicker` | 3749 |
| `closeGroundMaterialPicker` | 3769 |
| `openGroundPropPanel` | 3775 |
| `closeGroundPropPanel` | 3821 |
| `syncGroundPropPanel` | 3825 |
| `deleteSelectedGround` | 3835 |
| `setSelection` | 3840 |
| `updateSelBotBar` | 3868 |
| `applySelProps` | 3904 |
| `rotateSel` | 3914 |
| `dupSel` | 3933 |
| `deleteSel` | 3939 |
