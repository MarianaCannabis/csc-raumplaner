...
| Function | Line |
|---|---|
| `_loadTelemetryScripts` | 2397 |
| `_showCrashModal` | 2487 |
| `loadSharedFurniture` | 2680 |
| `saveSharedFurniture` | 2697 |
| `deleteSharedFurniture` | 2724 |
| `aiFetch` | 2741 |
| `callAI` | 2768 |
| `aiText` | 2816 |
| `aiJSON` | 2822 |
| `testAIConnection` | 2836 |
| `loadCustom` | 2884 |
| `saveCustom` | 2885 |
| `getCatalog` | 2895 |
| `getArchCatalog` | 2903 |
| `getSecurityCatalog` | 2904 |
| `toggleCatGroup` | 2905 |
| `findItem` | 2917 |
| `m2px` | 2945 |
| `px2m` | 2946 |
...
| `drawGround2D` | 3144 |
| `hitGround` | 3181 |
| `hitGroundResizeHandle` | 3198 |
| `_getImgCached` | 3213 |
| `drawObj2D` | 3224 |
| `drawMeasure` | 3326 |
| `hitObj` | 3347 |
| `hitRoom` | 3357 |
| `hitRoomResizeHandle` | 3365 |
| `startCatalogDrag` | 3631 |
| `placeFromCatalog` | 3641 |
| `quickAddRoom` | 3665 |
| `addRoom` | 3671 |
| `addObject` | 3693 |
| `removeRoom` | 3717 |
...
| `removeGround` | 3752 |
| `selectGround` | 3761 |
| `openGroundMaterialPicker` | 3771 |
| `closeGroundMaterialPicker` | 3791 |
| `openGroundPropPanel` | 3797 |
| `closeGroundPropPanel` | 3843 |
| `syncGroundPropPanel` | 3847 |
| `deleteSelectedGround` | 3857 |
| `setSelection` | 3862 |
| `updateSelBotBar` | 3890 |
| `applySelProps` | 3926 |
| `rotateSel` | 3936 |
| `dupSel` | 3955 |
| `deleteSel` | 3961 |
